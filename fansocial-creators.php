            ...
            <div class="ifugj <?php echo apply_filters( 'fansocial_boxed_width_class', 'bx_1200' ); ?>">
                <div class="DsIwi">
                    ...
                    <section class="VjPub">
                        ...
                        <!-- button-container -->
                        <div class="vEpUv gsCWf">
                            <button class="UJQCM DeYlt" onclick="initiate_slidein({
                            ...
                            <button class="UJQCM DeYlt reset-ajax-filter">
                            ...
                            <div class="active-filter-container">
                                <button class="UJQCM filter active-class filter-template" data-targetId="">
                                    <span></span>
                    ...
                    <div id="off-canvas-filters" class="fsImK">
                        ...
                        <form id="ajax-filters">
                            ...
                            <div class="price-filter rAHnB">
                                <h5>Filter by Age</h5>
                                <label class="filter-container">
                                    <input id="ajax_filter_field_age" type="text" name="ajax_filter[age]"
                                           class="ajax_filter_range_field">
                                </label>
                            </div>
